...
fs_nb$optVariables
# [1] "odor"               "stalk.root"               "gill.size"               
# [4] "gill.color"         "gill.spacing"             "stalk.shape"             
# [7] "cap.color"          "stalk.surface.above.ring" "stalk.surface.below.ring"
# [10] "cap.shape"         "bruises"                  "stalk.color.below.ring"  
